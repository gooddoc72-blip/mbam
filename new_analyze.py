                        ...
                        if is_blog:
                            ...
                            if not match:
                                ...
                                if query_match:
                                    ...
                                    # 메인 홈 주소인 경우
                                    return raw_url, {"error": "블로그 메인(홈) 주소입니다. 상세 분석은 불가합니다. 개별 포스팅 주소가 필요합니다."}
                            else:
                            ...
                            if not article_id:
                                ...
                                if cafe_match:
                                    ...
                                    # 모바일/PC URL에서 clubid와 articleid 추출
                            ...
                            # club_id가 없으면 URL로 접속해 리다이렉트 HTML에서 clubid 추출
