...
def run():
    ...
    with sync_playwright() as p:
        ...
        def on_res(r):
            if "pcmap-api.place.naver.com/graphql" in r.url and r.status == 200:
                try:
                    j = r.json()
                    graphql_data.append(j)
                    print("Intercepted GraphQL response!")
        ...
        iframe.locator("body").evaluate('''body => {
        ...
        with open("graphql_responses.json", "w", encoding="utf-8") as f:
