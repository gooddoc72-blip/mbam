  ...
  return (
    <div style={{ padding: "2rem", display: "flex", gap: "2rem", height: "100%", boxSizing: "border-box" }}>
      ...
      <div style={{ flex: 2, display: "flex", flexDirection: "column", gap: "1.5rem", overflowY: "auto", paddingRight: "10px" }}>
        <div>
          <h1 style={{ fontSize: "1.6rem", fontWeight: "bold", color: "#1e293b", margin: 0, marginBottom: "0.5rem" }}>블로그 포스팅 (SEO)</h1>
          <p style={{ color: "#64748b", margin: 0 }}>SEO 분석 데이터를 기반으로 최적화된 원고를 다중 계정에 자동 발행합니다.</p>
        </div>
        ...
        <div style={{ background: "white", padding: "1.5rem", border: "1px solid #cbd5e1" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            ...
            <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                <div onClick={() => setPromoType("place")} style={{ padding: "1rem", border: promoType === "place" ? "2px solid #8b5cf6" : "1px solid #cbd5e1", borderRadius: "8px", cursor: "pointer", background: promoType === "place" ? "#f5f3ff" : "white" }}>
                  <div style={{ fontSize: "1.5rem", marginBottom: "0.5rem" }}>📍</div>
                  <div style={{ fontWeight: "bold", color: "#0f172a", marginBottom: "0.2rem" }}>플레이스</div>
                  <div style={{ fontSize: "0.8rem", color: "#64748b" }}>네이버 플레이스 홍보</div>
                </div>
                <div onClick={() => setPromoType("product")} style={{ padding: "1rem", border: promoType === "product" ? "2px solid #8b5cf6" : "1px solid #cbd5e1", borderRadius: "8px", cursor: "pointer", background: promoType === "product" ? "#f5f3ff" : "white" }}>
                  <div style={{ fontSize: "1.5rem", marginBottom: "0.5rem" }}>🛍️</div>
                  <div style={{ fontWeight: "bold", color: "#0f172a", marginBottom: "0.2rem" }}>상품</div>
                  <div style={{ fontSize: "0.8rem", color: "#64748b" }}>쇼핑몰 상품 홍보</div>
                </div>
                <div onClick={() => setPromoType("general")} style={{ padding: "1rem", border: promoType === "general" ? "2px solid #8b5cf6" : "1px solid #cbd5e1", borderRadius: "8px", cursor: "pointer", background: promoType === "general" ? "#f5f3ff" : "white" }}>
                  <div style={{ fontSize: "1.5rem", marginBottom: "0.5rem" }}>📣</div>
                  <div style={{ fontWeight: "bold", color: "#0f172a", marginBottom: "0.2rem" }}>일반 홍보</div>
                  <div style={{ fontSize: "0.8rem", color: "#64748b" }}>브랜드·서비스 홍보</div>
                </div>
                <div onClick={() => setPromoType("hospital")} style={{ padding: "1rem", border: promoType === "hospital" ? "2px solid #8b5cf6" : "1px solid #cbd5e1", borderRadius: "8px", cursor: "pointer", background: promoType === "hospital" ? "#f5f3ff" : "white" }}>
                  <div style={{ fontSize: "1.5rem", marginBottom: "0.5rem" }}>🏥</div>
                  <div style={{ fontWeight: "bold", color: "#0f172a", marginBottom: "0.2rem" }}>병원블로그</div>
                  <div style={{ fontSize: "0.8rem", color: "#64748b" }}>의료법 준수 전문 포스팅</div>
                </div>
              </div>
            </div>
